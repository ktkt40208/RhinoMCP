...
internal static class ComputeServer
{
    ...
    public static T PostWithConverter<T>(string function, JsonConverter converter, params object[] postData)
    {
        ...
        string json = JsonSerializer.Serialize(postData, options);
    ...
    public static T0 Post<T0, T1>(string function, out T1 out1, params object[] postData)
    {
        ...
        using (var streamReader = new StreamReader(response.GetResponseStream()))
        {
            ...
            var ja = doc.RootElement;
            out1 = ja[1].Deserialize<T1>();
            return ja[0].Deserialize<T0>();
        }
    }
...
internal static class PythonCompute
{
    ...
    class ArchivableDictionaryResolver : JsonConverter<ArchivableDictionary>
    {
        public override ArchivableDictionary Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string encoded = reader.GetString();
            var dh = JsonSerializer.Deserialize<DictHelper>(encoded);
            return dh.SerializedDictionary;
        }

        public override void Write(Utf8JsonWriter writer, ArchivableDictionary value, JsonSerializerOptions options)
        {
            string json = JsonSerializer.Serialize(new DictHelper(value));
...
internal static class ExtrusionCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class BezierCurveCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class BrepCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class BrepFaceCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class CurveCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class GeometryBaseCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal class AreaMassProperties
{
...
internal static class AreaMassPropertiesCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal class VolumeMassProperties
{
...
internal static class VolumeMassPropertiesCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class MeshCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class NurbsCurveCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class NurbsSurfaceCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class SubDCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class SurfaceCompute
{
    static string ApiAddress([CallerMemberName] string caller = null)
    {
...
internal static class GrasshopperCompute
{
...
internal class GrasshopperObject
{
    ...
    {
        this.Data = JsonSerializer.Serialize(obj, obj.GetType(), GeometryResolver.Settings);
...
internal class GrasshopperPath
{
    public int[] Path
    {
        get; set;
...
internal class GrasshopperDataTree
{
